...
public class Student extends User implements Enrollable, Submittable {
    ...
    public double getGPA() {
        ...
        System.out.println(getName() + "'s GPA: " + String.format("%.1f", gpa));
        return gpa;
    }
    ...
    public List<Submission> getSubmissionHistory() { return Collections.unmodifiableList(submissionHistory); }
